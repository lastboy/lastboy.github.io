            ...
            if (data) {
                _interval = $interval(function(){
                    if (manager.init($scope, scrolldirective, data)) {
                         ...
                         */_cat.core.action(this, {"pkgName":"jqueryspa-test.js.controllers.app.menuTest"},this);_cat.core.action(this, {"pkgName":"jqueryspa-test.js.controllers.app.menuItemsAction"},this);
                    }
                }, 200) ;
            }
